...
export function resolveScrubConfig(overrides = {}) {
    ...
    return {
        ...
        minPreloaderMs: parseNumber(config.minPreloaderMs, DEFAULT_SCRUB_CONFIG.minPreloaderMs),
        preloadRootMargin: config.preloadRootMargin || DEFAULT_SCRUB_CONFIG.preloadRootMargin,
    };
}
